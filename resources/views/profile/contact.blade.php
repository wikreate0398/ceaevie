...
@section('content')
    <div class="page-header">
                ...
                </span> Связаться с нами </h3>
                    <p class="page-description">Если у Вас возникли вопросы и предложения связанные с работой сайта, пожалуйста свяжитесь с нами
                        <br> через форму обратной связи.</p>
                </div>
                <div class="row">
